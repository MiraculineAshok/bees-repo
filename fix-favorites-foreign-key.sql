-- Quick fix for interviewer_favorites foreign key constraint
-- Run this in your Neon Console to fix the 500 error when adding favorite questions
...
AND tc.table_name='interviewer_favorites'
