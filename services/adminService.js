    ...
    static async getQuestionsAnalytics() {
        ...
        try {
            ...
            try {
                ...
                console.log('✅ Retrieved questions with tags and score columns');
                return result.rows;
            } catch (tagsError) {
    ...
    static async createSession(sessionData) {
        ...
        try {
            ...
            const sessionResult = await client.query(`
                INSERT INTO interview_sessions (name, description, location_id, school_id, examination_mode_id, is_panel, is_online, bookings_service_id, bookings_workspace_id, created_by)
            ...
            `, [
                ...
                isPanel,
                !!sessionData.is_online,
                sessionData.bookings_service_id || null,
                sessionData.bookings_workspace_id || null,
                createdBy
            ]);
            ...
            const result = await pool.query(`
                SELECT 
                    ...
                    (
                        ...
                        FROM (
                            SELECT i2.verdict, i2.interview_date
                            FROM interviews i2
                            WHERE i2.student_id = s.id
                            AND i2.verdict IS NOT NULL
                            AND i2.verdict != ''
